        ...
        <div class="input_form">            
            ...
            <div class="input_box">
                ...
                <div class="summmary_box">
                    요약 <input class="summary" type="text">
                </div>

                <div class="goal_box">
                    펀딩목표수 <input class="goal" type="number">
                </div>

                <div class="open_date_box">
                    펀딩시작일 <input class="open_date" type="date">
                </div>

                <div class="end_date_box">
                    펀딩종료일 <input class="end_date" type="date">
                </div>

                <div class="price_box">
                    가격 <input class="price" type="number">
                </div>
