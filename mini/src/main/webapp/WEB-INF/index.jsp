	...
	<section id="mainContent" class="nth4">
	    <div class="wrapper">
			...
			<div class="mctArea <!-- mainContentSlider -->">
	            <div class="mctThumb typeCol" v-for="(item, index) in cardList"  @click="fnViewCard(item.cardNo)">
	    ...
	    <div class="wrapper">
	    	<div class="mctArea typeLeft">
		    	...
		    	<ul class="mctList" v-for="(item, index) in polList">
		    		<li>
			    		<span class="cateBox"><span>#</span>{{item.category}}</span>
			    		<h4 class="title"><a @click="fnViewPol(item.boardNo)" href="javaScript:;" target="_self">{{item.title}}</a></h4>
		    		</li>
		    	</ul>
	    	</div>
	    	<div class="mctArea typeRight">
	    		<a class="mctBanner" href="/recipe.do" target="_self" style="background:url('/images/mainBanner_img01.jpg') center center / cover no-repeat;">
	    			<p>당신을 위한 <b>레시피</b>는 <br>365일 <b>똑똑</b>에서</p>
	    		</a>
	    	</div>
	    </div>
	</section>
