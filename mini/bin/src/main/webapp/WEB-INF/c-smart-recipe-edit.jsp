	...
	<div class="wrapper">
        ...
        <fieldset>
          ...
          <fieldset>  
           ...
           <div id="add-area" @click="fnAddIndex()">
          ...
          <div class="btn_box">
            <button @click="fnEnrollRe()">등록</button>
            <button @click="fnEditRe()">수정</button>
            <button @click="fnDelRe()">삭제</button>
        </div>
...
, components: {VueEditor}
    ...
    fnAddIndex : function() {
        ...
        `<div id="step-num"><b>Step${self.cntRV}</b></div>
             <div>
                <label>레시피 이미지</label>
                <form action="">
                    <input type="file">
